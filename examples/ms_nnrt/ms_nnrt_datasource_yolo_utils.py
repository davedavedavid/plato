...
class COCOYoloDataset:
    ...
    def __init__(self, root, ann_file, aug_num, trainset_size, remove_images_without_annotations=True,
        ...
        self.mosaic = True
        self.trainset_size = trainset_size  # 296
        self.aug_num = aug_num  #5
        self.curr_aug_num = 0
    ...
    def __getitem__(self, index):
        ...
        """
        ##########################################
        if self.curr_aug_num != self.aug_num:
            index = index - self.trainset_size * self.curr_aug_num
        ##########################################
        coco = self.coco
