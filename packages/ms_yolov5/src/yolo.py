...
class YOLOv5(nn.Cell):
    def __init__(self, backbone, out_channel):
        ...
        self.backblock1 = YoloBlock(128, out_channel)
        self.backblock2 = YoloBlock(256, out_channel)
        self.backblock3 = YoloBlock(512, out_channel)
...
class TrainingWrapper(nn.Cell):
    ...
    def __init__(self, network, optimizer, sens=1.0):
        ...
        #print(self.network)
        #print(self.network.yolo_network.feature_map.backbone.focusv2)
