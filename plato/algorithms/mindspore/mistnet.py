...
class Algorithm(fedavg.Algorithm):
    ...
    def dataset_generator(trainset):
        ...
        for logit, annotation, batch_y_true_0, batch_y_true_1, batch_y_true_2, batch_gt_box0, batch_gt_box1, batch_gt_box2, img_hight, img_width, input_shape, z  in trainset:
